...
import com.codenjoy.dojo.AI.klyukin.Player;
...
public class YourSolver extends AbstractJsonSolver<Board> {
    ...
    public static void main(String[] args) {
        WebSocketRunner.runClient(
                ...
                "http://codebattle2020.westeurope.cloudapp.azure.com/codenjoy-contest/board/player/ckjjipa75akfbabw04y4?code=9118937951216272373&gameName=tetris",
